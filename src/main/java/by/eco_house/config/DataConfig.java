...
@ComponentScan(value = {"by.eco_house.entity", "by.eco_house.repository", "by.eco_house.service.implementation"})
@EnableJpaRepositories(basePackages = "by.eco_house.repository")
