...
export class AuctionComponent implements OnInit, OnDestroy {
  ...
  /**
   * Handle Start new eco_house click
   * Relocate to start new eco_house page
   */
  startNewAuction() {
    this.isAuthenticated() ? this.router.navigateByUrl('/eco_house/start') : this.router.navigateByUrl('/login');
  }
