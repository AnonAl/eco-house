...
export class AuctionDetailsComponent implements OnInit, OnDestroy {
  ...
  /**
   * Check is current user owner of this eco_house
  ...
  /**
   * Handle stop eco_house button click
   */
  stopAuction() {
  ...
  /**
   * Confirm stop eco_house message
   * Set for current eco_house status finished
   */
  confirmStopAuction() {
  ...
  /**
   * Decline stop eco_house message
   * Hide confirm modal
   */
  declineStopAuction() {
    this.confirmModal.hide();
